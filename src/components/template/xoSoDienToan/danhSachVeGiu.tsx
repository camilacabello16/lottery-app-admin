...
const DanhSachVeGiuScreen = () => {
    ...
    const getData = () => {
        console.log("AUTHO", loginData.userData.access_token);

        fetch(rootApi.rootApi + GET_HOLD_ORDER + "?gameId=2", {
            method: 'get',
            headers: {
    ...
    return (
        <View w="100%" alignItems="center">
            ...
            <Header headerTitle="XỔ SỐ ĐIỆN TOÁN" subTitle="Danh sách vé chờ" backArrow url='HomeScreen' />
...
export default DanhSachVeGiuScreen;
